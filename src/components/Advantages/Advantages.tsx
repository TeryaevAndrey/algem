  ...
  return (
    <div className="py-16 lg:py-60 lg:min-h-screen text-base-content-100 flex flex-col items-center text-center justify-center">
      <div className="max-w-[940px]">
        <h2 className="text-[32px] leading-[36px] lg:text-[64px] lg:leading-[70px] text-base-content-100">
        ...
        <p className="text-base lg:text-2xl mt-6 lg:mt-8 text-base-content-100 text-balance">
